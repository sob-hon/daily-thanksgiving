...
const cardData: CardData[] = [
  ...
  },
  {
    ...
    alt: "دوستان خوب",
    text: "شکر برای آدم‌های خوبی که توی مسیر زندگیم قرار میدی، همونا که با انرژی مثبت‌شون حالمو خوب می‌کنن.",
    category: "دوستان",
    date: "۱۴۰۳/۱۲/۱۳",
  },
  {
    ...
    text: "شکر برای موتور دوست‌داشتنیم که همیشه رفیق جاده‌ها هست و کلی خاطره باهاش دارم.",
    category: "سرگرمی",
    date: "۱۴۰۳/۱۲/۱۲",
  },
  {
    ...
    alt: "خانواده همسر",
    text: "شکر برای خانواده‌ی خوب همسرم که مثل بچه‌ی خودشون باهام رفتار می‌کنن و عشق واقعی رو ازشون یاد می‌گیرم.",
    category: "خانواده",
    date: "۱۴۰۳/۱۲/۱۱",
  },
  {
  ...
  },
  {
    ...
    alt: "نعمت‌ها",
    text: "ممنونم برای نعمت‌هایی که بهم میدی و منو قابل می‌دونی که ازشون بهره ببرم و ازت می‌خوام کمکم کنی که همیشه قدردانشون باشم.",
    category: "نعمت‌ها",
    date: "۱۴۰۳/۱۲/۱۱",
  },
  {
    ...
    alt: "محافظت",
    text: "خدایا شکرت برای چیزایی که به صلاحم نیست و بهم نمیدی، چون می‌دونم عاشقمی و همیشه بهترینا رو برام در نظر می‌گیری.",
    category: "محافظت",
    date: "۱۴۰۳/۱۲/۱۰",
  },
  {
    ...
    alt: "پدر و مادر",
    text: "شکر برای پدر و مادر و خواهر و مادربزرگ و دایی عزیزم که همیشه کنارم هستن و حمایتم می‌کنن.",
    category: "خانواده",
    date: "۱۴۰۳/۱۲/۱۱",
  },
  {
  ...
  },
  {
    ...
    alt: "چالش‌ها",
    text: "شکر برای چالش‌هایی که برام فراهم می‌کنی، چون هرکدوم منو قوی‌تر می‌کنند. می‌دونم که تو همیشه یاری‌ام می‌کنی تا اجازه ندم که منو بشکونن، بلکه با لطف بی‌پایانت می‌ذاری که منو بسازن.",
    category: "چالش‌ها",
    date: "۱۴۰۴/۰۱/۲۴",
  },
  {
    id: 27,
    image: "/images/self-discipline.png",
    alt: "نظم شخصی",
    text: "خدای مهربانم، شکر برای لحظاتی که بهم میدی.مرسی که کمکم می‌کنی با انضباط شخصی از وقتم درست استفاده کنم. تمام دقایقم رو با قلبی پر از شکر، به تو می‌سپارم.",
    category: "نظم شخصی",
    date: "۱۴۰۴/۰۲/۱۳",
  },
  {
